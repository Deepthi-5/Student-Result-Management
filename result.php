...
$qery = "SELECT   tblstudents.StudentName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,
tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId 
...
// Code for result
 ...
 CalculateGrade(t.marks) AS Grade,                
 CalculatePercentage(t.marks, 100) AS Percentage  
FROM
 (SELECT sts.StudentName, sts.RollId, sts.ClassId, tr.marks, SubjectId, sts.StudentId
...
<td style="text-align: center"><?php echo htmlentities($totalmarks=$result->marks);?></td>
    ...
    <td style="text-align: center">
        <b><?php echo htmlentities($result->Grade); ?> </b>
    </td>
